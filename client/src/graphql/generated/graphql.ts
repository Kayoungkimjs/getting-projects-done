...
export type UserInputSchema = {
  ...
  userId: Scalars['String']['input'];
  userProject: Array<UserProjectInputSchema>;
};

export type UserProjectInputSchema = {
  createdAt?: InputMaybe<Scalars['String']['input']>;
  ...
  updatedAt?: InputMaybe<Scalars['String']['input']>;
  user: UserInputSchema;
  userProjectId: Scalars['Float']['input'];
};

export type UserProjectSchema = {
  __typename?: 'UserProjectSchema';
  createdAt?: Maybe<Scalars['String']['output']>;
  ...
  user: UserSchema;
  userProjectId: Scalars['Float']['output'];
};
...
export type GetProjectByIdQuery = { __typename?: 'Query', getProjectById: { __typename?: 'GetProjectByIdResponseSchema', project: Array<{ __typename?: 'ProjectSchema', projectId: number, categoryId: number, categoryKr?: string | null, categoryEn?: string | null, endpoint?: string | null, testType?: string | null, testName?: string | null, criteria?: string | null }> } };

export type GetRegistersByUserIdQueryVariables = Exact<{ [key: string]: never; }>;


export type GetRegistersByUserIdQuery = { __typename?: 'Query', getRegistersByUserId: { __typename?: 'GetRegistersByUserIdResponseSchema', registers?: Array<{ __typename?: 'RegisterResponse', registerId: number, projectName?: string | null, description?: string | null, categoryId?: Array<string> | null, createdAt?: string | null }> | null } };
...
export type GetUserByIdQuery = { __typename?: 'Query', getUserById: { __typename?: 'UserSchema', uid: number, userId: string, password: string, email?: string | null, createdAt?: string | null, updatedAt?: string | null } };
...
export type RegisterProjectMutation = { __typename?: 'Mutation', registerProject: { __typename?: 'RegisterResponse', registerId: number, projectName?: string | null, description?: string | null, categoryId?: Array<string> | null, createdAt?: string | null, user: { __typename?: 'UserSchema', uid: number, userId: string } } };
 ...
 * });
 */
export function useGetRegistersByUserIdQuery(baseOptions?: Apollo.QueryHookOptions<GetRegistersByUserIdQuery, GetRegistersByUserIdQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetRegistersByUserIdQuery, GetRegistersByUserIdQueryVariables>(GetRegistersByUserIdDocument, options);
      }
export function useGetRegistersByUserIdLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetRegistersByUserIdQuery, GetRegistersByUserIdQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GetRegistersByUserIdQuery, GetRegistersByUserIdQueryVariables>(GetRegistersByUserIdDocument, options);
        }
export function useGetRegistersByUserIdSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<GetRegistersByUserIdQuery, GetRegistersByUserIdQueryVariables>) {
          const options = baseOptions === Apollo.skipToken ? baseOptions : {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<GetRegistersByUserIdQuery, GetRegistersByUserIdQueryVariables>(GetRegistersByUserIdDocument, options);
        }
export type GetRegistersByUserIdQueryHookResult = ReturnType<typeof useGetRegistersByUserIdQuery>;
export type GetRegistersByUserIdLazyQueryHookResult = ReturnType<typeof useGetRegistersByUserIdLazyQuery>;
export type GetRegistersByUserIdSuspenseQueryHookResult = ReturnType<typeof useGetRegistersByUserIdSuspenseQuery>;
export type GetRegistersByUserIdQueryResult = Apollo.QueryResult<GetRegistersByUserIdQuery, GetRegistersByUserIdQueryVariables>;
...
export const RegisterProjectDocument = gql`
  ...
  registerProject(input: $input) {
    ...
    `;
export type RegisterProjectMutationFn = Apollo.MutationFunction<RegisterProjectMutation, RegisterProjectMutationVariables>;
 ...
 * });
 */
export function useRegisterProjectMutation(baseOptions?: Apollo.MutationHookOptions<RegisterProjectMutation, RegisterProjectMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<RegisterProjectMutation, RegisterProjectMutationVariables>(RegisterProjectDocument, options);
      }
export type RegisterProjectMutationHookResult = ReturnType<typeof useRegisterProjectMutation>;
export type RegisterProjectMutationResult = Apollo.MutationResult<RegisterProjectMutation>;
export type RegisterProjectMutationOptions = Apollo.BaseMutationOptions<RegisterProjectMutation, RegisterProjectMutationVariables>;